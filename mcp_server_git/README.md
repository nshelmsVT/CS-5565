...
## Setup script (for the AI assistant)

1. Call `create_branch` with `name = "ai-branch"`.
2. Call `create_or_update_file` to write `ai_plan.md`.
3. Call `create_pull_request` from `ai-branch` to `main` with title "Auto plan".
